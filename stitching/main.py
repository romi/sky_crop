...
if __name__ == "__main__":
    ...
    [image_names.remove(i) for i in image_names if i[0]=="."]
    image_names.sort()
    # image_names.reverse()
    images = []
    ...
    for i in images:
        print (i)
        resized = imutils.resize(cv2.imread(i),FRAME_WIDTH)
        to_stitch.append(resized)

    print ("\t")
    print ("Resized: Starting to Stitch")
    print("\t")
