...
filepath = "/Users/soroush/Downloads/odm_orthophoto(2).tif"
...
rot_mat = cv2.getRotationMatrix2D((im.shape[0], im.shape[1]), angle * 180 / np.pi, 1.0)
warped = cv2.warpAffine(im, rot_mat, (diagonal*2, diagonal), flags=cv2.INTER_LINEAR)
